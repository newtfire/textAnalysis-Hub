...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Tara McGee - Github Test 4
    I changed spacing variables and added labels for each blob-->
    <!--
    ...
    <xsl:variable name="x-spacer" select="180"/>
    <xsl:variable name="y-spacer" select="12"/>
        ...
        <svg width="100%" height="600" viewBox="0 0 800 600">
            ...
            <g transform="translate(20 500)">
                ...
                <xsl:for-each select="descendant::blob">
                    ...
                    <text x="{$x-spacer * position()}" y="{$y-pos - 20}"
